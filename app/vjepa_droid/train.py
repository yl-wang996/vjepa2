...
def main(args, resume_preempt=False):
    ...
    dataset_format = cfgs_data.get("dataset_format", "droid")
    dataset_fpcs = cfgs_data.get("dataset_fpcs")
    max_num_frames = max(dataset_fpcs)
    camera_frame = cfgs_data.get("camera_frame", False)
    camera_views = cfgs_data.get("camera_views", ["left_mp4_path"])
    libero_camera_key = cfgs_data.get("libero_camera_key", "agentview_rgb")
    libero_frame_stride = cfgs_data.get("libero_frame_stride", 1)
    ...
    (unsupervised_loader, unsupervised_sampler) = init_data(
        ...
        libero_camera_key=libero_camera_key,
        libero_frame_stride=libero_frame_stride,
